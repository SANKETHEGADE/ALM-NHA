...
class ParalinguisticEncoder(nn.Module):
    """
    Paralinguistic Acoustic & Prosodic Feature Encoder.
    Extracts vocal emotion, prosodic dynamics, and pitch/energy frame embeddings.
    """
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            paralinguistic_embeddings: (B, T_out, embed_dim)
        """
